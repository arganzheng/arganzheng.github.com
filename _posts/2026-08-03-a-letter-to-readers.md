...
- 评论区上方有「<i class="fa fa-heart-o"></i> 有用」和「分享」两个按钮——觉得文章有用就点个心，不用登录，一个浏览器一票，再点取消。文章标题下那行小字末尾有四个小图标——阅读、有用、评论、分享——每个右上角挂一个橙色数字角标，首页列表里每篇也带着这四个数（悬停能看到完整说明）。分享菜单里任何一项用过一次，分享数就加一。这是我唯一能收到的、比阅读数更有信息量的反馈。
