...
**关于 AI-Infra 系统本身**：本系列讲的是 Python 这门语言在 AI-Infra 中的用法，不是推理系统的架构。如果你想了解 LLM Serving 系统本身如何设计——调度、KV Cache、GPU 执行、多卡并行、PD 分离——可以参考另一个系列[《大模型推理系统揭秘：从 vLLM 看 LLM Serving Infra 核心技术》](/deep-dive-into-vllm.html)。两个系列可以互为补充：一个讲语言与工程，一个讲系统与架构。
