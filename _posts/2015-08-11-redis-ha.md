...
基本上核心的类就这几个。其他的都是一些佛祖类，比如配置文件、序列化等。
...
2. [Redis Sentinel Documentation](http://redis.io/topics/sentinel)
3. [Redis几个认识误区](http://timyang.net/data/redis-misunderstanding/)
4. [新兵训练营系列课程——分布式缓存介绍](http://weibo.com/p/1001593874593080523716)
