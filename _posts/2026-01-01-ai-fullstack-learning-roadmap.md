...
**开头提问，结尾作答，再考一遍。** 每篇文章开头有一个粗体的核心问题，小结之后有一个折叠的「核心问题的答案」逐条回应它，再往后是一节「自测」——三到五道有确定答案的题，答案各自折叠。先自己答、再展开对，是检验"读懂了"最便宜的办法；答不上来就回到对应的章。两张地图上已发布的 142 篇系列文章全部按这个格式整理过。
