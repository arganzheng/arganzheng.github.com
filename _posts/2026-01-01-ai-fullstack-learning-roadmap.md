...
| AI 算法工程师 | 专属 54 篇、约 33 小时：L0 数学 8（3h），L1 工具箱 6（2.5h，深入篇共享 Infra 01、03），L2 经典机器学习 6（2h），L3 深度学习基础 6（3h），L4 共享 04 系列 + 预训练 4（4h），L5 后训练 8（6h），L6 高效推理与压缩 6（4h），L7 多模态 9（7h），横切实验方法论 1（1h） | — |
