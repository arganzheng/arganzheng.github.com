...
| [AI 应用工程师](/ai-application-engineer-learning-roadmap.html) | **用模型做产品的人**：在非确定性组件之上做可靠产品 | **在模型之上做出可靠的产品**：用哪个模型、怎么和检索 / 工具 / 人组合、上线后效果好不好 | 七层 + 横切 + 选修 | 地图已成，系列按 L1 → L7 逐个写：L1《模型作为组件》、L2《Prompt 与上下文工程》已成 |
...
Infra 05–12 八个系列 ≈ 133h`"]
    S7["`**7 用模型**
应用地图 L1–L7
L1 模型作为组件 6 篇 ≈ 3.5h · L2 上下文工程 6 篇 ≈ 2.5h · L3–L7 待写`"]
...
| AI 应用工程师 | 地图本身（含场景轴与三个 harness 案例）；L1 模型作为组件 6（3.5h）、L2 Prompt 与上下文工程 6（2.5h） | L3–L7 五个系列，按层的顺序逐个写 |
