...
| [AI 应用工程师](/ai-application-engineer-learning-roadmap.html) | **用模型做产品的人**：在非确定性组件之上做可靠产品 | **在模型之上做出可靠的产品**：用哪个模型、怎么和检索 / 工具 / 人组合、上线后效果好不好 | 七层 + 横切 + 选修 | 地图已成，系列按 L1 → L7 逐个写：L1《模型作为组件》、L2《Prompt 与上下文工程》、L3《检索与知识接入》、L4《工具、Agent 与 harness》、L5《评测、可观测与可追溯》、L6《生产化与运营》、L7《产品与体验》已成，七层齐 |
