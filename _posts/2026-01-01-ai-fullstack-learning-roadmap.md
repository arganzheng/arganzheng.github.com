...
| [AI 算法工程师](/ai-algorithm-engineer-learning-roadmap.html) | **造模型的人**：能复现论文、设计后训练配方、把模型评测清楚 | 为什么这样建模、效果如何、怎么证明 | 八层 + 横切 | L0–L5 写完；L6、L7 与横切待写 |
...
| AI 算法工程师 | L0–L2 各一篇导读，L3 深度学习基础 6 篇，L4 共享 04 系列，L5 后训练 8 篇 | L6 高效推理与压缩、L7 多模态、横切实验方法论 |
