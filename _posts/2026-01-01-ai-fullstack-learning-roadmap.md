...
| [AI 应用工程师](/ai-application-engineer-learning-roadmap.html) | **用模型做产品的人**：在非确定性组件之上做可靠产品 | **在模型之上做出可靠的产品**：用哪个模型、怎么和检索 / 工具 / 人组合、上线后效果好不好 | 七层 + 横切 + 选修 | 地图已成，系列按 L1 → L7 逐个写：L1《模型作为组件》已成 |
...
| AI 应用工程师 | 地图本身（含场景轴与三个 harness 案例）；L1 模型作为组件 6（3.5h） | L2–L7 六个系列，按层的顺序逐个写 |
