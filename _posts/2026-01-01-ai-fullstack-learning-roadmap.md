...
1. **算法基础**：算法地图 L0 数学八篇、L1 工具箱五篇——从零开始的地基。
2. **前置的深入篇**：Infra 01 Python、02 C++（可略）、03 PyTorch——01 与 03 两张地图共享，是 L1 的深入篇；然后回到算法地图 L2 经典机器学习六篇、L3 深度学习基础六篇。
...
| AI 算法工程师 | L0 数学 8 篇，L1 工具箱 5 篇（深入篇共享 Infra 01、03），L2 经典机器学习 6 篇，L3 深度学习基础 6 篇，L4 共享 04 系列 + 预训练 4 篇，L5 后训练 8 篇，L6 高效推理与压缩 6 篇，L7 多模态 7 篇，横切实验方法论 1 篇 | — |
