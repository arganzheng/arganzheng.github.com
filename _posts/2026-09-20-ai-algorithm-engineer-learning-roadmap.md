...
这是三张 AI 学习地图中的第二张。第一张[《AI-Infra 学习地图》](/ai-infra-learning-roadmap.html)面向为模型搭建训练与推理系统的工程师；这一张面向**做模型的人**——AI 算法工程师；第三张面向在模型之上做产品的 AI 应用工程师，另文梳理。三张地图各自独立，边界与重叠部分在每张地图的末尾说明。
