...
> 本文是[《PyTorch 深度实践：从 Tensor 到深度学习运行时》](/deep-dive-into-pytorch.html)系列的第 5 篇（共十篇）。上一篇：[`nn.Module` 与训练系统](/pytorch-module-and-training-system.html)；下一篇：[C++ 扩展与自定义算子](/pytorch-cpp-extension-and-custom-operators.html)
