...
（拆成[上：编译模型](/cpp-compilation-model-and-project-layout.html)与[下：工程布局](/cpp-project-layout-namespaces-libraries-and-cmake.html)两篇。）
