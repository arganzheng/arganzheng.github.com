...
Table: FlashAttention 驻留 SRAM 的张量
...
Table: Standard Attention 与 FlashAttention 的对比
...
Table: 未融合与融合后的 RMSNorm → RoPE → Residual
