...
(function () {
  ...
  var REMOVE = '.series-nav, .series-context, .series-toc, .pager, .related-posts, .comment, .annotation-comments, .annotation-panel, .annotation-marker, .annotation-toolbar, .sec-react, .code-copy, .fig-feedback, .fig-tools, .inline-popover-card, .post-share, .post-actions, .post-license, .post-stale, .catalog-toggle, .heading-anchor, script, style, noscript, .reversefootnote, .mermaidTooltip, hr[style*="hidden"]';
